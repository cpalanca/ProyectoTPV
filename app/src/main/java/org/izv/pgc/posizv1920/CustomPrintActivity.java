...
public class CustomPrintActivity extends AppCompatActivity {
    ...
    private boolean finalPagina = false;
    ...
    public class MyPrintDocumentAdapter extends PrintDocumentAdapter {
        ...
        public MyPrintDocumentAdapter(Context context, List<Product> productos, List<Command> comandas, List<Command> comandasAgrupadas, String nombreAux, double precioAux, ArrayList<Integer> idProductosComandas) {
            ...
            this.totalpages = contarNumeroPaginas();
            Log.v("xxx",""+ totalpages);// Ecuacion to guapa para calcular el numero de paginas extra en funcion de el numero de tuplas
        ...
        private void drawPage(PdfDocument.Page page, int pagenumber, int totalPages) {
            ...
            int separadorLeft = 25;
            int separadorMid = 270;
            int separadorRight = 460;
            int separdorY = 140;
...
*/
                ...
                canvas.drawText("NOMBRE", separadorLeft, separdorY, factura);

                factura.setTextSize(26);
                canvas.drawText("UNIDADES", separadorMid, separdorY, factura);

                factura.setTextSize(26);
                canvas.drawText("TOTAL", separadorRight, separdorY, factura);
                ...
                if (totalpages == pagenumber){
                    canvas.drawText("────────────────────────────────────────", 25, separador, factura);
                    canvas.drawText("Total: " + BillsActivity.total, separadorMid, separador + 25, factura);
    ...
    private int contarNumeroPaginas() {
        int resul;
        int sizeArray = comandasAgrupadas.size();
        String a = String.valueOf(sizeArray);
        Log.v("xxx", "comandas" + a);
        int cociente, resto;

        cociente = sizeArray / 15;
        resto = sizeArray % 15;
